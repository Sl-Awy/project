    ...
    return (
      <div className="mobile w-full flex items-center justify-between border-b py-2">
        <div className="flex h-16 gap-4 items-center">
          ...
          <img src={avatar8} alt="avatar" style={{ borderRadius: '50%', width: '100%', height: '100%', objectFit: 'cover'  }} />
          </div>
          <div className="flex flex-col">
            <span className="font-bold text-xl text-gray-50">Agata Christia</span>
            <span className="text-gray-400">Pick up your brother from school.</span>
          </div>
        </div>
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="button1 pm-2 text-blue-400 text-xs">18:05 PM</span>
        </div>
      </div>
    );
  };
